...
input_mp4 = "stevenvid.mp4"

# Output MP3 file
output_mp3 = "steveaudio.mp3"
...
adjusted_segments = concatenate_short_segments(adjusted_segments, de)
...
# After you have your adjusted_segments, add this code:

def generate_speech_for_segments(adjusted_segments, target_language, speaker_name="Luis Moray"):
    """
...
# Add this to your pipeline after the adjusted_segments are created
speech_segments = generate_speech_for_segments(adjusted_segments, de)  # Use your target language code
combine_speech_segments(speech_segments, "translated_audio.wav", output_mp3, volume_reduction=0.2)
...
# Add the translated audio to the original video
add_audio_to_video(input_mp4, "translated_audio.wav", "translated_video.mp4")
